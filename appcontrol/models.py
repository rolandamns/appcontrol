...
class jefe(models.Model):
     ...
     fechahora_creacion=models.DateField(default=datetime.datetime, blank=True)
...
class actividad(models.Model):
    ...
    dni = models.ForeignKey(persona, on_delete=models.PROTECT)
    ...
    id_dependencia = models.ForeignKey(dependencia, on_delete=models.PROTECT),
    nombre_dependencia = models.CharField(max_length=200, verbose_name="Dependencia", blank=True)
    
    gr_comorbilidad = models.BooleanField(verbose_name="Grupo de riesgo por comorbilidad", blank=True),
    detalle_comorbilidad = models.CharField(max_length=200, verbose_name="Detalle de comorbilidad", blank=True)
    ...
    link_informe = models.CharField(max_length=200, verbose_name="Link de informe", blank=True),   
    modalidad = models.CharField(max_length=200, verbose_name="Modalidad que trabajo", blank=True),
    dias_laborado = models.IntegerField( verbose_name="Resumen de actividad", blank=True)

    dni_jefe = models.ForeignKey(persona, on_delete=models.PROTECT),
    ...
    link_documento = models.CharField(max_length=200, verbose_name="Link de documento", blank=True),   
